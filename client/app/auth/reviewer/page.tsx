...
export default function Page() {
  ...
  const connectWallet = async () => {
    ...
    const resNonce = await fetch("https://agriethos-9wy5.onrender.com/api/agent/request-nonce", {
      method: "POST",
...
Only sign this message if you trust AgriEthos.
  ...
  console.log(addr,nonce,timestamp)
    ...
    const resLogin = await fetch("https://agriethos-9wy5.onrender.com/api/agent/wallet-login", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
