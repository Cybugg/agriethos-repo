      ...
      useEffect(
        ()=>{
          const fetchCrops = async() =>{
            try{
              const res = await fetch("https://agriethos-9wy5.onrender.com/api/crops/farmer/"+farmerId) 
              const {data} = await res.json();
              setCrops(data);
              console.log(data)
...
<div className="text-sm md:text-md min-h-screen px-5 py-5 lg:py-[80px] bg-white text-black">
      ...
      {/* ########################################################################################################### */}
       ...
       {/* ////////////////////////////////////////////////////////////////////////////////////////////// */}
              {/* */}
           <div className='w-full rounded-lg border-[0.75px] border-grey-200 p-4 gap-2 lg:gap-6 flex flex-col justify-start items-start  '>
